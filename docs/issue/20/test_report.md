...
| 2 | test_workload_generator_uniform | ✅ | 均匀分布到达生成 20 个请求 |
...
| 15v | test_sg_http_api_not_bound | ✅ | SGHttpApi 未 bind 时 → throw |
...
| 17v | test_sg_http_api_internal_state_not_bound | ✅ | 未 bind 时 internal state 返回 error |
...
| SGHttpApi 未 bind 时 → throw / error | 测试 15/17 变体 | ✅ |
